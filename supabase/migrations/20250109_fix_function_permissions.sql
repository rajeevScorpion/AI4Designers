-- =============================================
-- Migration: Fix function permissions for sync operations
-- Version: 20250109_fix_function_permissions
-- Date: 2025-01-09
-- Description: Ensures sync functions have proper permissions and UUID handling
-- =============================================
...
-- Drop existing get_progress_since function first
DROP FUNCTION IF EXISTS get_progress_since(TEXT, TIMESTAMPTZ);

-- Recreate get_progress_since function with proper UUID handling
...
-- Drop existing resolve_sync_conflict function first
DROP FUNCTION IF EXISTS resolve_sync_conflict(TEXT, INTEGER, JSONB, TEXT);

-- Recreate resolve_sync_conflict function with proper UUID handling
...
-- Ensure increment_sync_version function exists and is properly defined
...
SELECT 'Functions Created/Updated:' as status;
