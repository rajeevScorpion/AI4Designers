...
async function fetchUserProgress(supabase: any, userId: string, dayId: number) {
...
export default function Day({ params }: DayProps) {
  ...
  const { data: progress, isLoading } = useQuery({
    queryKey: ['user-progress', dayId, userId],
    queryFn: () => userId ? fetchUserProgress(supabase, userId, dayId) : null,
    enabled: !!userId
  })
